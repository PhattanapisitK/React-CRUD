...
export default function BookList() {
  ...
  useEffect(() => {
    axios
      .get("https://node57538-phattanapisitk.proen.app.ruk-com.cloud/books")
      .then((response) => {
  ...
  const viewBook = (id) => {
    axios
      .get(`https://node57538-phattanapisitk.proen.app.ruk-com.cloud/books/${id}`)
      .then((response) => {
  ...
  const updateBook = (book) => {
    ...
    // axios
    //   .put(`https://node57538-phattanapisitk.proen.app.ruk-com.cloud/books/${id}`)
    //   .then((response) => {
    //     setBook(response.data);
    //   });
  };
  ...
  const deleteBook = (id) => {
    axios
      .delete(`https://node57538-phattanapisitk.proen.app.ruk-com.cloud/books/${id}`)
      .then(() => {
